 ...
 * outra para a largura de um retângulo. Utilize essas constantes para calcular
 * e exibir no terminal as seguintes informações: 1. Área do retângulo
 * (comprimento × largura) 2. Perímetro do retângulo (soma dos 4 lados)
 */
